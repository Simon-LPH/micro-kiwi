 ...
 */
if(!defined('MAILER_DEBUG')) define('MAILER_DEBUG',true);
...
class PHPMailer {
  ...
  private function AddAnAddress($kind, $address, $name = '') {
    if (!preg_match('/^(to|cc|bcc|ReplyTo)$/', $kind)) {
      if(MAILER_DEBUG) echo 'Invalid recipient array: ' . kind;
      return false;
    }
    ...
    if (!self::ValidateAddress($address)) {
      ...
      if(MAILER_DEBUG) echo $this->Lang('invalid_address').': '.$address;
      return false;
    }
  if ($kind != 'ReplyTo') {
 ...
 */
  ...
  public function Send() {
    try {
      ...
      if(MAILER_DEBUG) echo $e->getMessage()."\n";
      return false;
    }
  }
